...
class MyCommandExecuteHandler(adsk.core.CommandEventHandler):
    ...
    def notify(self, args):
        ...
        try:
            ...
            lineCount = 0
            skippingBlanks = True # True when skipping a set of blank lines
                    ...
                    for iLine in range(len(lines)):
                        ...
                        for iPt in range(len(linePoints)):
                            ...
                            if Sketch_Style(_style) == Sketch_Style.SKETCH_POINTS:
                                ...
                                # Added by Haik, connecting lines
                                if iPt == 1:
                                    New_line = sketch_lines.addByTwoPoints(linePoints[iPt-1], linePoints[iPt])
                                if iPt > 1:
                                    New_line = sketch_lines.addByTwoPoints(New_line.endSketchPoint, linePoints[iPt])
